	...
	return (
		<Suspense
			...
			<div className='flex min-h-full flex-1 flex-col items-center justify-center px-6 py-12 lg:px-8'>
				<div className='bg-slate-50 border rounded-md shadow-md lg:w-1/3 md:w-1/2 w-full p-10'>
						...
						<form className='space-y-6' onSubmit={handleSubmit}>
							<div>
								<FormControl
									...
									onBlur={() => {
										if (isEmpty(fields.email)) handelFieldsBlur("email", "Email is required");
										else if (!isEmail(fields.email)) handelFieldsBlur("email", "Email is invalid");
									}}
							...
							<div>
								<FormControl
									...
									onBlur={() =>
										isEmpty(fields.password) && handelFieldsBlur("password", "Password is required")
									}
