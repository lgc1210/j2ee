...
public interface ProductRepository extends JpaRepository<ProductEntity, Long> {
    ...
    Page<ProductEntity> findAllByStoreIdAndCategoryContainingIgnoreCase(Long store_id, String category,
            Pageable pageable);

    Page<ProductEntity> findAllByStoreIdAndNameContainingIgnoreCaseAndCategoryContainingIgnoreCase(Long store_id,
