...
public class CategoryOfServiceController {
    ...
    // Create
    @PostMapping
    public ResponseEntity<CategoryOfServiceDTO> createCategory(@RequestBody CategoryOfServiceDTO categoryDTO) {
        try {
    ...
    // Update
    @PutMapping("/{id}")
    public ResponseEntity<CategoryOfServiceDTO> updateCategory(@PathVariable Integer id, @RequestBody CategoryOfServiceDTO categoryDTO) {
        try {
